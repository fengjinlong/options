          ...
          <div class="metric-item">
            ...
            <div class="input-with-unit">
              <input
                ...
                class="form-input"
              />
              <select v-model="projectData.fdvUnit" class="unit-select">
                <option value="1">个</option>
                <option value="1000000">m (百万)</option>
                <option value="1000000000">b (十亿)</option>
              </select>
            </div>
          </div>
          ...
          <div class="metric-item">
            ...
            <div class="input-with-unit">
              <input
                ...
                class="form-input"
              />
              <select v-model="projectData.mcapUnit" class="unit-select">
                <option value="1">个</option>
                <option value="1000000">m (百万)</option>
                <option value="1000000000">b (十亿)</option>
              </select>
          ...
          <div class="metric-item">
            ...
            <div class="input-with-unit">
              <input
                ...
                class="form-input"
              />
              <select v-model="projectData.tvlUnit" class="unit-select">
                <option value="1">个</option>
                <option value="1000000">m (百万)</option>
                <option value="1000000000">b (十亿)</option>
              </select>
          ...
          <div class="metric-item">
            ...
            <div class="input-with-unit">
              <input
                ...
                class="form-input"
              />
              <select v-model="projectData.revenueUnit" class="unit-select">
                <option value="1">个</option>
                <option value="1000000">m (百万)</option>
                <option value="1000000000">b (十亿)</option>
              </select>
          ...
          <div class="metric-item">
            ...
            <div class="input-with-unit">
              <input
                ...
                class="form-input"
              />
              <select v-model="projectData.netRevenueUnit" class="unit-select">
                <option value="1">个</option>
                <option value="1000000">m (百万)</option>
                <option value="1000000000">b (十亿)</option>
              </select>
...
// 综合状态计算
const calculateOverallStatus = (statuses: any) => {
...
// 风险等级计算
const calculateRiskLevel = (statuses: any) => {
  const riskCount = Object.values(statuses).filter((status) =>
    ["高风险", "高估", "高估警示", "极端高估", "极高风险"].includes(status)
  ).length;
